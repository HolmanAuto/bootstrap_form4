...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test "adding both prepend and append text with validation error" do
    ...
    HTML
    assert_equivalent_xml expected, bootstrap_form4_for(@user) { |f| f.text_field :email, prepend: "$", append: ".00" }
  end
  ...
  test "help messages to warn about deprecated I18n key" do
    ...
    builder = BootstrapForm4::FormBuilder.new(:super_user, super_user, self, {})
  ...
  test "custom form group layout option" do
    ...
    HTML
    assert_equivalent_xml expected, bootstrap_form4_for(@user, layout: :horizontal) { |f| f.email_field :email, layout: :inline }
  end

  test "non-default column span on form is reflected in form_group" do
    non_default_horizontal_builder = BootstrapForm4::FormBuilder.new(:user, @user, self, layout: :horizontal,
                                                                     label_col: "col-sm-3",
  ...
  test "non-default column span on form isn't mutated" do
    frozen_horizontal_builder = BootstrapForm4::FormBuilder.new(:user, @user, self, layout: :horizontal,
