...
class BootstrapSelectsTest < ActionView::TestCase
  ...
  test "time zone selects are wrapped correctly with error" do
    ...
    HTML
    assert_equivalent_xml expected, bootstrap_form4_for(@user) { |f| f.time_zone_select(:misc) }
  end
  ...
  test "collection_selects are wrapped correctly with error" do
    ...
    HTML
    assert_equivalent_xml expected, bootstrap_form4_for(@user) { |f| f.collection_select(:status, [], :id, :name) }
  end
  ...
  test "grouped_collection_selects are wrapped correctly with error" do
    ...
    HTML
    assert_equivalent_xml expected,
                          bootstrap_form4_for(@user) { |f| f.grouped_collection_select(:status, [], :last, :first, :to_s, :to_s) }
  end
  ...
  test "date selects inline when layout is horizontal" do
    travel_to(Time.utc(2012, 2, 3)) do
      ...
      HTML
      assert_equivalent_xml expected, bootstrap_form4_for(@user, layout: :horizontal) { |f| f.date_select(:misc) }
    end
  end
  ...
  test "date selects are wrapped correctly with error" do
    ...
    travel_to(Time.utc(2012, 2, 3)) do
      ...
      HTML
      assert_equivalent_xml expected, bootstrap_form4_for(@user) { |f| f.date_select(:misc) }
    end
  end
  ...
  test "time selects are wrapped correctly with error" do
    ...
    travel_to(Time.utc(2012, 2, 3, 12, 0, 0)) do
      ...
      HTML
      assert_equivalent_xml expected, bootstrap_form4_for(@user) { |f| f.time_select(:misc) }
    end
  end
  ...
  test "datetime selects are wrapped correctly with error" do
    ...
    travel_to(Time.utc(2012, 2, 3, 12, 0, 0)) do
      ...
      HTML
      assert_equivalent_xml expected, bootstrap_form4_for(@user) { |f| f.datetime_select(:misc) }
    end
  end
